        ...
        <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="table_member">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($auth_service_role['role'] == 'admin' || $auth_service_role['role'] == 'admin99')
                                        <button class="btn edit-btn btn-sm" data-id="{{ $msg->id }}" data-title="{{ $msg->id }}"data-toggle="modal" data-target="#edit-message" style="margin-right: 0;"><i class="icon-pencil"></i>編輯</button>
                ...
                <div class="pull-left">
                    <div class="pagination-panel">
                        顯示第 1 到 10 筆
                        <form class="form-inline" id="form-search" method="GET" action="/msgsample">
